...
// 1. Render UI พร้อม CSS จัดกึ่งกลาง
document.getElementById('checkPage').innerHTML = `
    <style>
        ...
        .table-area th { padding: 12px; border-bottom: 2px solid #e2e8f0; text-align: center !important; background: #f8fafc; }
        .table-area td { padding: 10px; border-bottom: 1px solid #f1f5f9; text-align: center !important; }
        ...
        <div class="side-controls">
            <div class="box">
                ...
                <div id="fileDisplay" class="hidden" style="padding:15px; border:2px dashed #3b82f6; border-radius:12px; background:#eff6ff;">
                    ...
                    <button onclick="confirmResetImport()" style="display:block; margin-top:10px; font-size:11px; color:#ef4444; border:1px solid #fca5a5; border-radius:4px;">เปลี่ยนไฟล์ใหม่</button>
                </div>
            </div>
            <div class="box">
                <b>2. สแกนตรวจสอบ</b>
    ...
    <div id="customModal" class="modal-overlay hidden">
        <div class="modal-content">
            ...
            <div style="display:flex; gap:10px;">
                <button onclick="closeCustomModal()" style="flex:1; padding:10px; border-radius:8px; border:none; background:#f1f5f9;">ยกเลิก</button>
                <button id="mConfirmBtn" style="flex:1; padding:10px; border-radius:8px; border:none; background:#333; color:white;">ตกลง</button>
            </div>
        </div>
    </div>
`;

// --- ฟังก์ชันแยกจากกันเด็ดขาด (ห้ามซ้อนกัน) ---
...
function importCheckData() {
    ...
    if (!staff || !raw || !bankName) return alert("กรุณากรอกข้อมูลให้ครบ");
